...
type EntityResponseType = HttpResponse<IFormula>;
type EntityArrayResponseType = HttpResponse<IFormula[]>;
...
export class FormulaService {
  ...
  update(formula: IFormula): Observable<EntityResponseType> {
    return this.http.put<IFormula>(this.resourceUrl, formula, { observe: 'response' });
  }
