...
public class TaskResourceIntTest {
    ...
    public void createTask() throws Exception {
        ...
        assertThat(testTask.getShortDescription()).isEqualTo(DEFAULT_SHORT_DESCRIPTION);
        assertThat(testTask.getTaskDescription()).isEqualTo(DEFAULT_TASK_DESCRIPTION);
        assertThat(testTask.getSolution()).isEqualTo(DEFAULT_SOLUTION);
    }
    ...
    public void updateTask() throws Exception {
        ...
        assertThat(testTask.getShortDescription()).isEqualTo(UPDATED_SHORT_DESCRIPTION);
        assertThat(testTask.getTaskDescription()).isEqualTo(UPDATED_TASK_DESCRIPTION);
        assertThat(testTask.getSolution()).isEqualTo(UPDATED_SOLUTION);
    }
