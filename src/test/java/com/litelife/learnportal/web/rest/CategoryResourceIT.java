...
public class CategoryResourceIT {
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getFullName()).isEqualTo(DEFAULT_FULL_NAME);
    }
    ...
    public void updateCategory() throws Exception {
        ...
        assertThat(testCategory.getFullName()).isEqualTo(UPDATED_FULL_NAME);
    }
