...
describe('Task e2e test', () => {
  ...
  it('should create and save Tasks', async () => {
    ...
    expect(await taskUpdatePage.getShortDescriptionInput()).to.eq(
      'shortDescription',
      'Expected ShortDescription value to be equals to shortDescription'
    );
    expect(await taskUpdatePage.getTaskDescriptionInput()).to.eq(
      'taskDescription',
      'Expected TaskDescription value to be equals to taskDescription'
    );
