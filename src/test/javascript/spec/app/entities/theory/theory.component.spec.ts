...
describe('Component Tests', () => {
    describe('Theory Management Component', () => {
        let comp: TheoryComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(TheoryComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.theories[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
